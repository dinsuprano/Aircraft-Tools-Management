...
<div class="p-6 max-w-2xl">
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 mt-1">Assign an available tool to an employee</p>
    </div>
    ...
    <form action="{{ route('borrows.store') }}" method="POST" class="space-y-5">
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-5">
            ...
            <div>
                ...
                <select name="barcode" required class="w-full px-4 py-3 rounded-xl bg-slate-800/50 border border-slate-700 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-colors">
            ...
            <div>
                <label class="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Select Employee <span class="text-rose-400">*</span></label>
                <select name="employee_id" required class="w-full px-4 py-3 rounded-xl bg-slate-800/50 border border-slate-700 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-colors">
